...
Example: [[['C3;Car', 4.4711], ['C3;Car', 4.6541], ['C3;O3', 4.2251], ['C3;HO', 4.8206]], 14], where 14 - number of ligand atoms.

This step can be conducted using structural_data.py script. The command is “python structural_data.py directory name”. Directory is a folder containing structural files. It is supposed that the files are organized in folders containing separate files for ligand and protein binding pocket. Recommended format for ligand - .sdf. Name is name for output file without extention.
2.	Prediction of binding energy.
